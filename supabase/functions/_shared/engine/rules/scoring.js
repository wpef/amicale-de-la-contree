...
export function calculateTrickPoints(tricks, trumpSuit) {
...
export function hasBelote(hand, trumpSuit) {
...
export function isCapot(tricks, team) {
 ...
 */
export function calculateRoundScore(tricks, contract, beloteTeam) {
